...
const SUITES = ["editor", "tracks", "palette", "responsive", "import-safety", "pitched-staff", "perform", "fretboard", "ascii-tab", "musicxml", "recording", "share-save", "collab", "accounts", "shared-device", "listening"];
