...
const SUITES = ["editor", "tracks", "palette", "responsive", "import-safety", "pitched-staff", "perform", "fretboard", "ascii-tab", "musicxml", "songwriting", "midi-import", "recording", "share-save", "collab", "accounts", "shared-device", "listening"];
